...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="text-center py-4 my-4">Welcome To My To Do List</h1>

    <div class="w-50 m-auto">
    <form action="data.php" method="post" autocomplete="off">
        <div class="form-group">
            <label for="title">To Do  List</label>
            <input class="form-control" type="text" name="title" id="title" placeholder="Ketik Di Sini" Required><br>
            <label for = "date" >Deadline</label>
            <input type="date" class="form-control" name="date" id="date"><br>
        </div><br>
        <button class="btn btn-success">Add To ToDoList</button>
    </form>
        ...
        if($result){
            while($row=mysqli_fetch_assoc($result)){
                ...
                <tr>
                    ...
                    <td><?php echo $sts ?></td>
                    <td>
                    <a class="btn btn-warning btn-sm" href="edit.php?id=<?php echo $id ?>" role="button">Edit</a>
